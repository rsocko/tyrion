...
export default function ChatPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-6 flex flex-col h-[calc(100vh-2rem)]">
      <div className="mb-6">
        <h1 className="text-2xl font-bold">AI Finance Chat</h1>
        <p className="text-sm text-muted mt-1">Ask questions about your spending, budgets, and finances</p>
      </div>
      ...
      <div className="flex-1 bg-card border border-border rounded-xl p-5 overflow-y-auto mb-4">
        <div className="space-y-4">
          ...
          <div className="flex gap-3">
            <div className="w-7 h-7 rounded-full bg-accent/20 flex items-center justify-center text-xs shrink-0">🤖</div>
            <div className="bg-zinc-800/50 rounded-lg p-3 max-w-[80%]">
              <p className="text-sm">
                Hi! I&apos;m your AI finance assistant. I can help you understand your spending patterns,
          ...
          <div className="flex gap-3 justify-end">
            ...
            <div className="w-7 h-7 rounded-full bg-zinc-700 flex items-center justify-center text-xs shrink-0">👤</div>
          </div>
          ...
          <div className="flex gap-3">
            ...
            <div className="bg-zinc-800/50 rounded-lg p-3 max-w-[80%]">
              <p className="text-sm">
                Jake has spent <span className="font-mono font-medium text-red-300">$142</span> on gaming this month (June 2026).
      ...
      <div className="flex gap-2 mb-3 flex-wrap">
        <button className="px-3 py-1.5 rounded-lg text-xs bg-card border border-border hover:bg-zinc-800 transition-colors">
      ...
      <div className="flex gap-2">
        ...
        />
        <button className="px-4 py-2.5 rounded-lg bg-accent text-white text-sm font-medium hover:bg-accent/90 transition-colors">
          Send
        </button>
      </div>
    </div>
